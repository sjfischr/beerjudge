  ...
  return (
    <div className="space-y-8">
      <section className="rounded-[2rem] border border-stone-200 bg-white p-8 shadow-sm">
        ...
        <h1 className="mt-3 text-3xl font-semibold tracking-tight text-stone-900">Archived competitions</h1>
        <p className="mt-3 max-w-3xl text-base leading-7 text-stone-600">
          Past competitions are read-only. Browse final results and revisit your own feedback.
        </p>
      </section>
      ...
      <section className="grid gap-4">
          ...
          >
            <div className="flex flex-wrap items-start justify-between gap-4">
              <div>
                ...
                <p className="mt-2 text-sm leading-6 text-stone-600">{competition.description || 'Competition archived.'}</p>
              </div>
        ...
        {!competitions.length ? <p className="text-sm text-stone-600">No competitions have been archived yet.</p> : null}
      </section>
    </div>
  );
}
